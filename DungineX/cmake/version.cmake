...
function(dgex_extract_version)
    file(READ "${CMAKE_CURRENT_LIST_DIR}/include/DgeX/Version.h" file_contents)
    ...
    string(REGEX MATCH "DGEX_VERSION_REVISION ([0-9]+)" _ "${file_contents}")
    if(NOT CMAKE_MATCH_COUNT EQUAL 1)
    ...
    set(DGEX_VERSION_REVISION ${ver_revision} PARENT_SCOPE)

    set(DGEX_VERSION "${ver_major}.${ver_minor}.${ver_patch}.${ver_revision}" PARENT_SCOPE)
endfunction()

# --------------------------------------------------------------------
# File Properties Generation
# --------------------------------------------------------------------
# Adapted from https://github.com/halex2005/CMakeHelpers where:
#   - Icon is removed as is not used
# --------------------------------------------------------------------
