...
void OpenGLWindow::_InitEventCallback() const
{
    ...
    glfwSetMouseButtonCallback(_window, [](GLFWwindow* window, int button, int action, int /*mods*/) {
        ...
        {
        case GLFW_PRESS:
            data.EventCallback(MouseButtonPressedEvent::Create(static_cast<MouseCode>(button)));
            break;
        case GLFW_RELEASE:
            data.EventCallback(MouseButtonReleasedEvent::Create(static_cast<MouseCode>(button)));
            break;
        default:
            break;
        }
