 ...
 */
template <typename T>
constexpr T RangeToStep(T begin, T end, T t)
{
...
constexpr T Interpolate(T initial, T target, S step, EasingFn<S> fn)
{
 ...
 */
template <typename T>
constexpr T EaseInBack(T x, T c)
{
...
template <typename T>
constexpr T EaseOutBack(T x, T c)
{
...
template <typename T>
constexpr T EaseInOutBack(T x, T c)
{
    const T s = c * T(1.525);
...
template <typename T>
EasingFn<T> StyleToEasingFn(const std::string& style)
{
    ...
    if (style == "ease-in" || style == "ease-in-sine")
    {
        return EaseInSine;
    }
    if (style == "ease-out" || style == "ease-out-sine")
    {
        return EaseOutSine;
    }
    if (style == "ease-in-out" || style == "ease-in-out-sine")
    {
        return EaseInOutSine;
    }
    if (style == "ease-in-quad")
    {
        return EaseInQuad;
    }
    if (style == "ease-out-quad")
    {
        return EaseOutQuad;
    }
    if (style == "ease-in-out-quad")
    {
        return EaseInOutQuad;
    }
    if (style == "ease-in-cubic")
    {
        return EaseInCubic;
    }
    if (style == "ease-out-cubic")
    {
        return EaseOutCubic;
    }
    if (style == "ease-in-out-cubic")
    {
        return EaseInOutCubic;
    }
    if (style == "ease-in-elastic")
    {
        return EaseInElastic;
    }
    if (style == "ease-out-elastic")
    {
        return EaseOutElastic;
    }
    if (style == "ease-in-out-elastic")
    {
        return EaseInOutElastic;
    }
    if (style == "ease-in-bounce")
    {
        return EaseInBounce;
    }
    if (style == "ease-out-bounce")
    {
        return EaseOutBounce;
    }
    if (style == "ease-in-out-bounce")
    {
